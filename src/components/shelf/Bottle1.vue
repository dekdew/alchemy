	...
	<div>
		...
		<svg class="bottle" x="0px" y="0px" viewBox="0 0 60 70">
			<g>
				...
				<linearGradient id="SVGID_7_" gradientUnits="userSpaceOnUse" x1="-109.005" y1="-78.09" x2="-109.005"
					y2="-31.31" gradientTransform="matrix(1 0 0 -1 0 -30)">
					<stop offset="0" style="stop-color:#808080" />
					<stop offset="1" style="stop-color:#FFFFFF" />
				</linearGradient>
				<polygon class="st1"
					points="-114.96,1.31 -112.91,21.22 -137.25,48.09 -80.76,48.09 -104.04,21.22 -102.35,1.33 					" />
				...
				<linearGradient id="SVGID_14_" gradientUnits="userSpaceOnUse" x1="-108.81" y1="-78.09" x2="-108.81"
					y2="-31.32" gradientTransform="matrix(1 0 0 -1 0 -30)">
					<stop offset="0" style="stop-color:#808080" />
					<stop offset="1" style="stop-color:#FFFFFF" />
				</linearGradient>
				<polygon class="st3"
					points="-112.91,1.32 -111.33,21.22 -133.71,47.67 -83.91,48.09 -106.13,21.22 -104.87,1.33 					" />
				...
				<linearGradient id="SVGID_21_" gradientUnits="userSpaceOnUse" x1="-108.81" y1="-35.11" x2="-108.81"
					y2="-29.91" gradientTransform="matrix(1 0 0 -1 0 -30)">
					<stop offset="0" style="stop-color:#808080" />
					<stop offset="1" style="stop-color:#FFFFFF" />
				</linearGradient>
				...
				<linearGradient id="SVGID_22_" gradientUnits="userSpaceOnUse" x1="30" y1="-100" x2="30" y2="-53.22"
				...
				<linearGradient id="SVGID_23_" gradientUnits="userSpaceOnUse" x1="30.195" y1="-100" x2="30.195"
					y2="-53.23" gradientTransform="matrix(1 0 0 -1 0 -30)">
					<stop offset="0" style="stop-color:#CFFFE8" />
					<stop offset="1" style="stop-color:#4AEFB1" />
				</linearGradient>
				<polygon class="st7" points="26.09,23.23 27.67,43.13 5.3,69.58 55.09,70 32.88,43.13 34.13,23.24 		" />

				<linearGradient id="SVGID_24_" gradientUnits="userSpaceOnUse" x1="30.195" y1="-57.02" x2="30.195"
					y2="-51.82" gradientTransform="matrix(1 0 0 -1 0 -30)">
					<stop offset="0" style="stop-color:#CFFFE8" />
					<stop offset="1" style="stop-color:#4AEFB1" />
				</linearGradient>
				<polygon class="st8" points="21.03,21.82 22.22,27.02 37.7,27.02 39.35,21.82 		" />

				<linearGradient id="SVGID_25_" gradientUnits="userSpaceOnUse" x1="30.195" y1="-100" x2="30.195"
					y2="-64.53" gradientTransform="matrix(1 0 0 -1 0 -30)">
				...
				<polygon class="st10"
					points="32.63,27.96 31.92,44.04 45.17,69.34 54.15,69.91 33.59,42.46 35.24,27.96 		" />
				<polygon class="st10"
					points="25.13,27.96 26.73,43.09 4.62,69.59 16.74,69.59 28.98,42.09 27.73,28.55 		" />
...
@keyframes text-shadow {
    ...
    50% {  
        transform: translateY(0.5em);
		filter: drop-shadow(0 0 18px #DE3129);
    }
