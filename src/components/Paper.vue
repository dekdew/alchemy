    ...
    <div class="foo">
        <div class="center">
			...
			s-15.5,2.7-26.5-1.3s-12.3,2.9-16.6,1.3C53.6,75.6,54.7,73.8,52.3,75.1z" />
                    <path class="st1"
                        d="M74.2,27.4c0,0,4,0.3,3.7-0.8c-0.3-1.1-4.6-2.4-5.1-1.1C72.3,26.9,74.2,27.4,74.2,27.4z" />
            ...
            <div class="paper left">
                <svg x="0px" y="0px" viewBox="0 0 180 100">
                    <path class="st0"
                        d="M15.8,92.5l-1,4.5c0,0,4.3,3.2,9.4,2.9l0.8-2.1l1,2.2c0,0,5.6,0,8.8-2.9l-2.7-4.3L15.8,92.5z" />
                    <path class="st1"
                        d="M9.7,5.5c0,0,7.8,49.8,3.5,87.3c0,0,12,9.1,22.5,0c0,0-18.2-46.3-3.7-88.6C31.9,4.1,22.3,0.9,9.7,5.5z" />
                    <path class="st2"
                        d="M9.7,5.5c0,0,7,3.2,15.8,1.1l1.9,8.6l1.1-9.4L32,4.2C31.9,4.1,22.5,0.1,9.7,5.5z" />
            ...
            <div class="paper right">
                <svg x="0px" y="0px" viewBox="0 0 180 100">
                    <path class="st0"
                        d="M164.2,91.4l1.1,4.6c0,0-4.3,3.2-9.4,2.9l-0.8-2.1l-1.1,2.1c0,0-5.6,0-8.8-2.9l2.7-4.3L164.2,91.4z" />
                    <path class="st1"
                        d="M170.3,4.4c0,0-7.8,49.8-3.5,87.3c0,0-12,9.1-22.5,0c0,0,18.2-46.3,3.7-88.6C148.1,3.1,157.7-0.1,170.3,4.4z" />
                    <path class="st2"
                        d="M170.3,4.4c0,0-7,3.2-15.8,1.1l-1.9,8.6l-1.1-9.4L148,3.1C148.1,3.1,157.5-0.9,170.3,4.4z" />
